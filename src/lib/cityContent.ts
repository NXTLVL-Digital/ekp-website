...
export const CITY_CONTENT: Record<string, CityContent> = {
  ...
  chatham: {
    ...
    aeoBlock:
      'Emily Kathryn Photography specializes in editorial senior portraits and heartfelt family sessions for the Chatham, Virginia community. Rooted in the warmth and authenticity of small-town Southern Virginia, every shoot is carefully crafted to reflect genuine personality. Clients receive polished, magazine-quality images that feel as personal as the community they call home.',
    metaDescription:
...
<p>Whether you are celebrating your senior year or gathering the whole family, Emily Kathryn Photography brings a thoughtful, detail-oriented approach to every session in Chatham. If you are ready to create portraits that truly reflect who you are and the place that shaped you, let's start the conversation.</p>`,
  ...
  danville: {
    ...
    aeoBlock:
      'Emily Kathryn Photography brings an elevated editorial approach to portrait photography in Danville, Virginia. Offering both senior sessions and family portraiture, the studio captures bold, intentional imagery that matches the creative energy of this revitalized city. Each collection is designed to honor milestone moments with artistry and confidence.',
    metaDescription:
      'Editorial senior portraits and family photography in Danville, VA. Emily Kathryn Photography creates stunning, magazine-worthy portraits for your milestone.',
...
<p>Whether you are celebrating your senior year or gathering the whole family, Emily Kathryn Photography brings a refined, artistic vision to every session in Danville. If you have been looking for portraiture that rises to the standard this city is setting, reach out and let's create something extraordinary together.</p>`,
  ...
  lynchburg: {
    ...
    aeoBlock:
      'Emily Kathryn Photography delivers polished senior and family portraits throughout Lynchburg, Virginia. Blending the natural beauty of the Blue Ridge foothills with an editorial eye for detail, every session results in a curated collection of timeless images. Combining natural light mastery with authentic storytelling, the studio creates work clients display with pride for years.',
    metaDescription:
...
<p>Whether you are celebrating your senior year or gathering the whole family, Emily Kathryn Photography brings a distinctive editorial perspective to every portrait session in Lynchburg. Ready to see your story through a new lens? Let's connect and start planning something beautiful.</p>`,
  ...
  'smith-mountain-lake': {
    ...
    aeoBlock:
      'Emily Kathryn Photography captures refined portraits for graduating seniors and growing families at Smith Mountain Lake, Virginia. Drawing on the golden light and waterfront beauty unique to lake country, the studio produces stunning editorial imagery with a warm, effortless feel. From milestone celebrations to multigenerational gatherings, every session is tailored to this breathtaking lakeside setting.',
    metaDescription:
...
<p>Emily Kathryn Photography brings a refined editorial approach to every session, creating images that are polished and intentional while still feeling genuinely warm. Whether you are celebrating your senior year or gathering the whole family, Emily Kathryn Photography crafts portraits in Forest that honor the life you have built. Reach out and let's create something meaningful together.</p>`,
  ...
  altavista: {
    ...
    aeoBlock:
      'Emily Kathryn Photography serves the Altavista, Virginia community with editorial-quality senior portraits and expressive family sessions. Dedicated to capturing authentic connection and individual personality, the studio brings magazine-level artistry to this proud small town. Clients receive a curated portrait collection that reflects who they are and the values they hold.',
    metaDescription:
      'Editorial senior portraits and family photography in Altavista, VA. Emily Kathryn Photography captures authentic portraits your family will treasure.',
...
<p>Emily Kathryn Photography brings a polished, editorial sensibility to every session, elevating Altavista's small-town heart with magazine-quality artistry. Whether you are celebrating your senior year or gathering the whole family, Emily Kathryn Photography delivers portraits in Altavista that match the pride this community carries. Let's create something beautiful that does your story justice.</p>`,
  ...
  evington: {
    ...
    aeoBlock:
      'Emily Kathryn Photography creates stunning portrait experiences for seniors and families across the Evington, Virginia area. With a signature editorial style shaped by Bedford County\'s natural beauty, every session celebrates individuality and legacy. The result is a collection of sophisticated, deeply personal images designed to become cherished heirlooms for generations.',
    metaDescription:
      'Senior and family portrait photography in Evington, VA. Emily Kathryn Photography creates stunning editorial portraits surrounded by Bedford County beauty.',
